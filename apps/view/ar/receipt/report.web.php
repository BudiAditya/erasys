    ...
    <table cellpadding="1" cellspacing="1" class="tablePadding tableBorder">
        ...
        <?php
            ...
            while ($row = $Reports->FetchAssoc()) {
                ...
                printf("<td nowrap='nowrap'>%s</td>",$row["warkat_no"]);
                printf("<td nowrap='nowrap'>%s</td>",left($row["warkat_date"],10));
                printf("<td nowrap='nowrap'>%s</td>",$row["receipt_descs"]);
        ...
        print("<tr>");
        print("<td colspan='10' align='right'>Total Penerimaan</td>");
