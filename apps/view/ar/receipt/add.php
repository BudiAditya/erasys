...
<div id="p" class="easyui-panel" title="Entry Penerimaan Piutang" style="width:100%;height:100%;padding:10px;" data-options="footer:'#ft'">
    <form id="frmMaster" action="<?php print($helper->site_url("ar.receipt/add")); ?>" method="post">
        <table cellpadding="0" cellspacing="0" class="tablePadding" align="left" style="font-size: 13px;font-family: tahoma">
            ...
            <tr>
                <td>Penerimaan</td>
                <td colspan="3"><b><input type="text" class="f1 easyui-textbox" id="ReceiptDescs" name="ReceiptDescs" style="width: 450px" maxlength="150" value="<?php print($receipt->ReceiptDescs != null ? $receipt->ReceiptDescs : '-'); ?>" required/></b></td>
                <td>Status</td>
