...
<html>
<head>
	<title>ERASYS - Entry Divisi Barang</title>
...
<fieldset>
	...
	<form action="<?php print($helper->site_url("master.itemdept/add")); ?>" method="post">
		<table cellspacing="0" cellpadding="0" class="tablePadding" style="margin: 0 auto;">
			...
			<tr>
				...
				<td><button type="submit" class="button">Simpan</button>
                    &nbsp&nbsp
                    <a href="<?php print($helper->site_url("master.itemdept")); ?>" class="button">Batal</a>
                </td>
			</tr>
		</table>
	</form>
