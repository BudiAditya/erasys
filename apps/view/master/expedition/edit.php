...
<fieldset>
	...
	<form action="<?php print($helper->site_url("master.expedition/edit/".$expedition->Id)); ?>" method="post">
		<table cellspacing="0" cellpadding="0" class="tablePadding" style="margin: 0;">
			...
			<tr>
				...
				<td><button type="submit" class="button">UPDATE</button>
                    &nbsp&nbsp
                    <a href="<?php print($helper->site_url("master.expedition")); ?>" class="button">Batal</a>
                </td>
			</tr>
		</table>
	</form>
