...
<html>
<head>
    <title>ERASYS - Edit Kelompok Barang</title>
...
<fieldset>
    ...
    <form action="<?php print($helper->site_url("master.itemgroup/edit/".$itemgroup->BgId)); ?>" method="post">
        <table cellspacing="0" cellpadding="0" class="tablePadding" style="margin: 0 auto;">
            ...
            <tr>
                ...
                <td><button type="submit" class="button">Update</button>
                    &nbsp&nbsp
                    <a href="<?php print($helper->site_url("master.itemgroup")); ?>" class="button">Datftar Kelompok Barang</a>
                </td>
            </tr>
        </table>
    </form>
