...
<div style="padding:50px;">
	<table align="center" width="100%" border="0" cellpadding="4" cellspacing="0">
		<td align="center">
			<img src="<?php print(base_url('public/images/company/stk.png'));?>" width="220" height="100">
			<img src="<?php print(base_url('public/images/company/scm.png'));?>" width="220" height="100">
			<img src="<?php print(base_url('public/images/company/rjy.png'));?>" width="200" height="100">
		</td>
	</table>
	<div align="center">
		<h1 style="color: #0000FF">ERASYS - INTEGRATED SALES SYSTEM</h1>
	</div>
	<hr/>
