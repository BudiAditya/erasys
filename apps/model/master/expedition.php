...
class Expedition extends EntityBase {
	...
	public function Insert() {
		$this->connector->CommandText = 'INSERT INTO m_expedition(cabang_id,exp_code,exp_name,address,phone,fax,cperson,createby_id,create_time) VALUES(?cabang_id,?exp_code,?exp_name,?address,?phone,?fax,?cperson,?createby_id,now())';
	...
	public function Update($id) {
		$this->connector->CommandText = 'UPDATE m_expedition SET cabang_id = ?cabang_id, address = ?address, phone = ?phone, fax = ?fax, cperson = ?cperson, exp_code = ?exp_code, exp_name = ?exp_name, updateby_id = ?updateby_id, update_time = now() WHERE id = ?id';
        $this->connector->AddParameter("?cabang_id", $this->CabangId);
		$this->connector->AddParameter("?exp_code", $this->ExpCode,"varchar");
        $this->connector->AddParameter("?exp_name", $this->ExpName);
        $this->connector->AddParameter("?address", $this->Address);
