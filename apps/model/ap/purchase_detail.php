...
"INSERT INTO t_ap_purchase_detail(ex_po_no,is_free,grn_id, cabang_id, grn_no, item_id, item_code, item_descs, l_qty, s_qty, purchase_qty, return_qty, price, disc_formula, disc_amount, sub_total)
VALUES(?ex_po_no,?is_free,?grn_id, ?cabang_id, ?grn_no, ?item_id, ?item_code, ?item_descs, ?l_qty, ?s_qty, ?purchase_qty, ?return_qty, ?price, ?disc_formula, ?disc_amount, ?sub_total)";
